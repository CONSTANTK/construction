...
<header id="header" class="header d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><a href="{{asset('front/index.html')}}" class="active">Home</a></li>
                <li><a href="{{asset('front/about.html')}}">About</a></li>
                <li><a href="{{asset('front/services.html')}}">Services</a></li>
                <li><a href="{{asset('front/projects.html')}}">Projects</a></li>
                <li><a href="{{asset('front/blog.html')}}">Blog</a></li>
...
<section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <a class="carousel-control-prev" href="{{asset('front/assets/img/hero-carousel/hero-carousel-1.jpg')}}" role="button" data-bs-slide="prev">
            ...
            <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="post-item position-relative h-100">
                    ...
                    <div class="post-content d-flex flex-column">
                        ...
                        <a href="{{asset('front/blog-details.html')}}" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
    ...
    <div class="footer-legal text-center position-relative">
        <div class="container">
            ...
            <div class="credits">
                ...
                Designed by <a href="{{asset('front/https://bootstrapmade.com/')}}">BootstrapMade</a>
            </div>
        </div>
    </div>
